...
int main() {
   ...
   success = company10.remove(emp1, oneEmployee); 
   delete oneEmployee;
   success = company11.remove(emp2, oneEmployee);  
   delete oneEmployee;
   ...
   cout << "company10 " << (company10 == company11 ? "equals":"does not equal") 
        << " company11" << endl;
   success = company10.remove(emp2, oneEmployee); 
   delete oneEmployee;
   success = company11.remove(emp1, oneEmployee); 
   delete oneEmployee;
   cout << "Company10:" << endl << company10 << endl;
   cout << "Company11:" << endl << company11 << endl;
   cout << "company10 " << (company10 == company11 ? "equals":"does not equal") 
