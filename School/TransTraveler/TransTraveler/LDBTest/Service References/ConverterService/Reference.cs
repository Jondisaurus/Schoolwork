...
// 
namespace LDBTest.ConverterService {
    ...
    public interface CurrencyConvertorSoap {
        ...
        System.IAsyncResult BeginConversionRate(LDBTest.ConverterService.Currency FromCurrency, LDBTest.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CurrencyConvertorSoapChannel : LDBTest.ConverterService.CurrencyConvertorSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CurrencyConvertorSoapClient : System.ServiceModel.ClientBase<LDBTest.ConverterService.CurrencyConvertorSoap>, LDBTest.ConverterService.CurrencyConvertorSoap {
        ...
        System.IAsyncResult LDBTest.ConverterService.CurrencyConvertorSoap.BeginConversionRate(LDBTest.ConverterService.Currency FromCurrency, LDBTest.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        double LDBTest.ConverterService.CurrencyConvertorSoap.EndConversionRate(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginConversionRate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            LDBTest.ConverterService.Currency FromCurrency = ((LDBTest.ConverterService.Currency)(inValues[0]));
            LDBTest.ConverterService.Currency ToCurrency = ((LDBTest.ConverterService.Currency)(inValues[1]));
            return ((LDBTest.ConverterService.CurrencyConvertorSoap)(this)).BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }
        
        private object[] OnEndConversionRate(System.IAsyncResult result) {
            double retVal = ((LDBTest.ConverterService.CurrencyConvertorSoap)(this)).EndConversionRate(result);
            return new object[] {
                    retVal};
        }
        ...
        public void ConversionRateAsync(LDBTest.ConverterService.Currency FromCurrency, LDBTest.ConverterService.Currency ToCurrency) {
            this.ConversionRateAsync(FromCurrency, ToCurrency, null);
        }
        
        public void ConversionRateAsync(LDBTest.ConverterService.Currency FromCurrency, LDBTest.ConverterService.Currency ToCurrency, object userState) {
        ...
        protected override LDBTest.ConverterService.CurrencyConvertorSoap CreateChannel() {
            return new CurrencyConvertorSoapClientChannel(this);
        }
        
        private class CurrencyConvertorSoapClientChannel : ChannelBase<LDBTest.ConverterService.CurrencyConvertorSoap>, LDBTest.ConverterService.CurrencyConvertorSoap {
            
            public CurrencyConvertorSoapClientChannel(System.ServiceModel.ClientBase<LDBTest.ConverterService.CurrencyConvertorSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginConversionRate(LDBTest.ConverterService.Currency FromCurrency, LDBTest.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState) {
