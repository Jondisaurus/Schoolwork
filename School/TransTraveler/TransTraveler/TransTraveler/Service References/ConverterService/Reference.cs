...
// 
namespace TransTraveler.ConverterService {
    ...
    public interface CurrencyConvertorSoap {
        ...
        System.IAsyncResult BeginConversionRate(TransTraveler.ConverterService.Currency FromCurrency, TransTraveler.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface CurrencyConvertorSoapChannel : TransTraveler.ConverterService.CurrencyConvertorSoap, System.ServiceModel.IClientChannel {
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class CurrencyConvertorSoapClient : System.ServiceModel.ClientBase<TransTraveler.ConverterService.CurrencyConvertorSoap>, TransTraveler.ConverterService.CurrencyConvertorSoap {
        ...
        System.IAsyncResult TransTraveler.ConverterService.CurrencyConvertorSoap.BeginConversionRate(TransTraveler.ConverterService.Currency FromCurrency, TransTraveler.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState) {
        ...
        private System.IAsyncResult OnBeginConversionRate(object[] inValues, System.AsyncCallback callback, object asyncState) {
            TransTraveler.ConverterService.Currency FromCurrency = ((TransTraveler.ConverterService.Currency)(inValues[0]));
            TransTraveler.ConverterService.Currency ToCurrency = ((TransTraveler.ConverterService.Currency)(inValues[1]));
            return ((TransTraveler.ConverterService.CurrencyConvertorSoap)(this)).BeginConversionRate(FromCurrency, ToCurrency, callback, asyncState);
        }
        
        private object[] OnEndConversionRate(System.IAsyncResult result) {
            double retVal = ((TransTraveler.ConverterService.CurrencyConvertorSoap)(this)).EndConversionRate(result);
            return new object[] {
                    retVal};
        }
        ...
        public void ConversionRateAsync(TransTraveler.ConverterService.Currency FromCurrency, TransTraveler.ConverterService.Currency ToCurrency) {
            this.ConversionRateAsync(FromCurrency, ToCurrency, null);
        }
        
        public void ConversionRateAsync(TransTraveler.ConverterService.Currency FromCurrency, TransTraveler.ConverterService.Currency ToCurrency, object userState) {
        ...
        protected override TransTraveler.ConverterService.CurrencyConvertorSoap CreateChannel() {
            return new CurrencyConvertorSoapClientChannel(this);
        }
        
        private class CurrencyConvertorSoapClientChannel : ChannelBase<TransTraveler.ConverterService.CurrencyConvertorSoap>, TransTraveler.ConverterService.CurrencyConvertorSoap {
            
            public CurrencyConvertorSoapClientChannel(System.ServiceModel.ClientBase<TransTraveler.ConverterService.CurrencyConvertorSoap> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginConversionRate(TransTraveler.ConverterService.Currency FromCurrency, TransTraveler.ConverterService.Currency ToCurrency, System.AsyncCallback callback, object asyncState) {
